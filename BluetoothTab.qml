...
Item {
    ...
    property color mPrimary: "#10b981"
    property color mOnSurface: "#ffffff"
    property color mSurface: "#2d2d2d"
        ...
        Item {
            ...
            Row {
                ...
                MouseArea {
                    ...
                    onClicked: root.back()
                    Text { anchors.centerIn: parent; text: "󰁍"; font.pixelSize: 18; color: Theme.active }
                }
